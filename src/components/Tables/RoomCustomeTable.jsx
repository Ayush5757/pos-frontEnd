          ...
          <Grid gutter={7}>
            <Grid.Col span={5} sm={3}>
              <PrimaryButton
                ...
                onClick={() => {
                  if (
                    (tdata.length !== 0 && Rooms.length !== 0) ||
                    inventries?.roomPrice > 0
                  ) {
                    save();
                  } else {
              ...
              <>
                ...
                <Grid.Col span={12} xs={6} sm={4} lg={4}>
                  <Select
                    ...
                    onChange={(val)=>{
                      dispatch(PaymentMethodRoom(
                        {room , paymentMethod: val}
                      ))
                    }}
...
export default RoomCustomeTable;
